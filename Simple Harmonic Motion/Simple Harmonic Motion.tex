...
\addplot [only marks, mark=square] table[y error=sigma] {\datatable};
...
\begin{center}$0.4=\frac{2\pi}{k}$\end{center}
\begin{center}$k=\frac{2\pi}{0.4}$\end{center}
\begin{center}$k=15.7$\end{center}
